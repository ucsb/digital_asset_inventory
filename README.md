...
- **Visual Dashboard**
  At-a-glance inventory health with Chart.js charts, accessible table fallbacks, and colorblind-safe palette
...
| `/admin/digital-asset-inventory/dashboard` | Visual dashboard |
