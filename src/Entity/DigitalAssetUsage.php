...
class DigitalAssetUsage extends ContentEntityBase {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['embed_method'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('How the asset is embedded (field_reference, drupal_media, html5_video, html5_audio, text_link, inline_image, inline_object, inline_embed, inline_iframe, text_url, link_field, menu_link).'))
      ->setSettings([
        'max_length' => 32,
        'text_processing' => 0,
      ])
